...
(function () {
    ...
    function Projects($log, $sce) {
        ...
        vm.projects = [
            ...
            {
                title: 'AngularJS - Clean Shot',
                titleMuted: 'AngularJS',
                titleLeft: $sce.trustAsHtml(' &mdash; Clean Shot'),
                img: 'angarticle.png',
                imgBig: 'angarticle_big.png',
                urlAccess: 'https://medium.com/@adrael/angularjs-clean-shot-4c5d09f4b12c',
                urlGit: '',
                text: $sce.trustAsHtml('Want a run on AngularJS? Here you go folks!<br><br><br>')
            }
        ];
